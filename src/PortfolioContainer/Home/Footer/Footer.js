...
export default function Footer() {
  ...
  let socialDetails = [
    {
      icon: faLinkedin,
      link: 'https://www.linkedin.com/in/karandeepsingh13/',
    },
    { icon: faGithub, link: 'https://github.com/Karandeep1390' },
  ];
    ...
    <div className="main-footer-container">
      <div className="main-footer-content">
        <div className="main-footer-message">
          <span> All rights reserved © Karandeep Singh {currentYear} </span>
        </div>
